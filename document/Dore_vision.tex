...
\chapter{Hell}
\newpage
\subfile{sections/book_1.tex}

\chapter{Purgatory}
\newpage
\subfile{sections/book_2.tex}

\chapter{Heaven}
\newpage
\subfile{sections/book_3.tex}

\nocite{alighieri2009divine} % include reference in bibliography without citing within the text
\nocite{alighieri1868commedia}
\bibliographystyle{ieeetran}
\cleardoublepage
\addcontentsline{toc}{chapter}{Bibliography} % addition of bibliography to table of content
